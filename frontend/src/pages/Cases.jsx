      ...
      {showForm && (
        <form className={styles.form} onSubmit={handleSubmit}>
          ...
          <div className={styles.inputGroup}>
            ...
            >
              {["Civil", "Criminal", "Family", "Corporate", "Other"].map(
                (t) => (
          ...
          <div className={styles.inputGroup}>
            ...
            <input
              ...
              onChange={(e) =>
                setForm({ ...form, hearingTime: e.target.value })
              }
            />
          </div>
          <div className={styles.inputGroup}>
            ...
            <input
              ...
              onChange={(e) =>
                setForm({ ...form, hearingNotes: e.target.value })
              }
            />
          </div>
          {!editId && (
          ...
          cases.map((c) => (
            <div key={c._id} className={styles.card}>
              <div className={styles.cardTop}>
                ...
                <span className={`${styles.badge} ${badgeClass[c.status]}`}>
                  {c.status}
                </span>
              </div>
              ...
              {c.documents?.length > 0 && (
                <div className={styles.docsSection}>
                  <button
                    ...
                    onClick={() =>
                      setExpandedCase(expandedCase === c._id ? null : c._id)
                    }
                  >
